				...
				<div className="about-description">
					<div className="description-sub">
						<p>
							...
							perfectly into this passion. I began teaching myself web development in January 2020 and
							immediately enjoyed the challenge and creativity that programming offers. Brewing gave me a
							continous improvement mindset and I improve, learn, and create new things every day.
						</p>
					</div>
				</div>
			</div>
